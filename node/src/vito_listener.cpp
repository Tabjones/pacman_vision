...
bool
Listener::cb_get_cloud_in_hand(pacman_vision_comm::get_cloud_in_hand::Request& req, pacman_vision_comm::get_cloud_in_hand::Response& res)
{
...
void
Listener::listen_and_crop_detailed_hand_piece(bool right, size_t idx, PC::Ptr& cloud)
{
...
void
Listener::listen_and_extract_detailed_hand_piece(bool right, size_t idx, PC::Ptr& cloud, PC::Ptr& piece)
{
...
void
Listener::listen_detailed_hand_piece(bool right, size_t idx, geometry_msgs::Pose &pose)
{
    std::string sens_ref_frame, hand, hand_piece;
    this->storage->read_sensor_ref_frame(sens_ref_frame);
    tf::StampedTransform tf_piece;
